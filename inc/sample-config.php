<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'icon'             => 'el el-universal-access',
            ...
            array(
                ...
                'desc'     => __( 'Введите текст логотипа', 'redux-framework-demo' ),
            ...
            array(
                ...
                'desc'       => __( 'Загрузите картинку логотипа.', 'redux-framework-demo' ),
                'subtitle'   => __( '', 'redux-framework-demo' ),
            ),
            array(
                'id'       => 'dublin-logo-sub',
                'type'     => 'text',
                'title'    => __( 'Текст подписи', 'redux-framework-demo' ),
                'subtitle' => __( '', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст подписи', 'redux-framework-demo' ),
                'default'  => 'ipad'// 1 = on | 0 = off
            )
    ...
    Redux::setSection( $opt_name, array(
        ...
        'icon'             => 'el el-inbox',
            'fields'           => array(
            array(
                'id'       => 'dublin-footer-logo',
                'type'     => 'text',
                'title'    => __( 'Текст логотипа футера', 'redux-framework-demo' ),
                'subtitle' => __( '', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст логотипа футера', 'redux-framework-demo' ),
                'default'  => '1'// 1 = on | 0 = off
            ),
            array(
                'id'         => 'dublin-footer-img',
                'type'       => 'media',
                'title'      => __( 'Изображение логотипа футера', 'redux-framework-demo' ),
                'full_width' => true,
                'mode'       => false,
                // Can be set to false to allow any media type, or can also be set to any mime type.
                'desc'       => __( 'Загрузите картинку логотипа.', 'redux-framework-demo' ),
            ...
            array(
                'id'       => 'dublin-footer-sub',
                'type'     => 'text',
                'title'    => __( 'Текст подписи  футера', 'redux-framework-demo' ),
                'subtitle' => __( '', 'redux-framework-demo' ),
                'desc'     => __( 'Введите текст подписи', 'redux-framework-demo' ),
                'default'  => 'ipad'// 1 = on | 0 = off
            )
