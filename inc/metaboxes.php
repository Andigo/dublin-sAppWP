...
function aletheme_metaboxes($meta_boxes) {
	...
	$meta_boxes[] = array(
		'id'         => 'connect_metaboxes',
		'title'      => 'Settings for Connect Page',
		'pages'      => array( 'page', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		'show_on'    => array( 'key' => 'page-template', 'value' => array('template-connect.php'), ), // Specific post templates to display this metabox
		'fields' => array(
			...
			array(
				'name' => __('Title','aletheme'),
				'desc' => __('Paste your title','aletheme'),
				'id'   => $prefix . 'title',
				'std'  => '',
				'type' => 'text',
			),
	...
	$meta_boxes[] = array(
		...
		'fields' => array(
			...
			array(
				'name' => __('Home_title','aletheme'),
				'desc' => __('Paste your title here','aletheme'),
				'id'   => $prefix . 'home_title',
				'std'  => '',
				'type' => 'text',
			),
			array(
				'name' => __('Home_subtitle','aletheme'),
				'desc' => __('Paste your subtitle','aletheme'),
				'id'   => $prefix . 'home_subtitle',
				'std'  => '',
				'type' => 'text',
			),
			array(
				'name' => __('Home_subtitle_bold','aletheme'),
				'desc' => __('Paste your subtitle','aletheme'),
				'id'   => $prefix . 'home_boldsubtitle',
				'std'  => '',
				'type' => 'text',
			),
			array(
				'name' => __('Home_text','aletheme'),
				'desc' => __('Paste your text','aletheme'),
				'id'   => $prefix . 'home_text1',
				'std'  => '',
				'type' => 'text',
			),
			array(
				'name' => __('Home_text','aletheme'),
				'desc' => __('Paste your text','aletheme'),
				'id'   => $prefix . 'home_text2',
				'std'  => '',
				'type' => 'text',
			),
			array(
				'name' => __('Home_btn_text','aletheme'),
				'desc' => __('Paste your button text','aletheme'),
				'id'   => $prefix . 'home_btntext',
				'std'  => '',
				'type' => 'text',
			)
		)
	...
	$meta_boxes[] = array(
		'id'         => 'abilities_metaboxes',
		'title'      => 'Subtitles for abilities post type',
		'pages'      => array( 'abil', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		'show_on'    => array( 'key' => 'page-template', 'value' => array('template-home.php'), ), // Specific post templates to display this metabox
		'fields' => array(
			array(
				'name' => __('Abilities','aletheme'),
				'desc' => __('Abilities','aletheme'),
				'id'   => $prefix . 'abil_subtitle',
				'std'  => '',
				'type' => 'text',
			)
		)
