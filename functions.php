...
if ( ! function_exists( 'dublin_setup' ) ) :
	...
	function dublin_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'dublin' ),
		) );
...
function dublin_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'dublin' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'dublin' ),
...
function dublin_scripts() {
	wp_enqueue_style( 'dublin-style', get_template_directory_uri().'/style/styles.css');
	wp_enqueue_style( 'dublin-slick', get_template_directory_uri().'/style/slick.css');
	wp_deregister_script( 'jquery' );
	wp_enqueue_script( 'jquery', get_template_directory_uri().'/js/jquery.js');
	wp_enqueue_script( 'dublin-navigation', get_template_directory_uri().'/js/navigation.js', array(), '20151215', true );
	wp_enqueue_script( 'dublin-slick-js', get_template_directory_uri().'/js/slick.min.js', array(), 'jquery');
	wp_enqueue_script( 'dublin-scripts', get_template_directory_uri().'/js/scripts.js', array(), 'dublin-slick-js');
	wp_enqueue_script( 'dublin-skip-link-focus-fix', get_template_directory_uri().'/js/skip-link-focus-fix.js', array(), '20151215', true );
...
function dublin_add_scripts($hook) {
...
add_action( 'admin_enqueue_scripts', 'dublin_add_scripts', 10 );
 ...
 */
require get_template_directory() . '/inc/truemeta.php';
